...
title('Correlation Matrix delay (5) (sigma = 10)');
colorbar;

subplot(1, 3, 2);
imagesc(correlation_matrix_10_d10);
title('Correlation Matrix delay (10) (sigma = 100)');
colorbar;

subplot(1, 3, 3);
scatter(correlation_matrix_10(:),correlation_matrix_10_d10(:))
title('scatter plot of correlation matrix and delay correlation matrix');
colorbar;
